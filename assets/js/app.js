/* ============================================================================
   ...
   Architecture
   ------------
   - contentData.js loads first and defines the global `CDPSE` namespace with
...
(function () {
  ...
  var PASS = EX.passing;                    // passing scaled score (from CDPSE.exam)
  ...
  var Store = (function () {
    ...
    return {
      ...
      get: function (k, fb) { return read("cdpse." + k, fb); },
      set: function (k, v) { write("cdpse." + k, v); },
      del: function (k) { try { localStorage.removeItem("cdpse." + k); } catch (e) {} }
    };
  })();
  ...
  function renderDashboard() {
    ...
    b1.appendChild(el("p.sectsub", { text: "Start here. Understand how the CDPSE is scored and delivered as a fixed-form, 120-question exam, and where the credential fits in a technical data-privacy and privacy-engineering career." }));
    var g1 = el("div.grid");
    g1.appendChild(card({
      icon: "🎓", tag: "OVERVIEW", title: "Exam Mechanics", cls: "",
      desc: "Format, timing, scoring, and question style of the CDPSE &mdash; the high-stakes details every candidate should internalize before sitting the test.",
    ...
    g1.appendChild(card({
      ...
      desc: "Where CDPSE sits on the career ladder: the privacy-engineering and data-protection judgment it certifies, and the privacy engineer, DPO, and data-governance roles it unlocks.",
    ...
    if (window.FLASH) {
      ...
      gf2.appendChild(card({
        ...
        desc: "Every CDPSE acronym across all four domains in one deck &mdash; the highest-yield rote material on the exam.",
    ...
    b5.appendChild(el("p.sectsub", { html: "A realistic, full-length simulation of the CDPSE &mdash; " + EX.maxQuestions + " questions weighted to the official domain percentages. Sit it under timed conditions to benchmark your readiness." }));
    var g3c = el("div.grid");
    ...
    g5.appendChild(card({
      ...
      desc: "Vetted, free study tools: the official ISACA CDPSE exam content outline, canonical review manuals, video walkthroughs, and trusted community resources.",
    ...
    g5.appendChild(card({
      ...
      desc: "Plan your certification journey: browse 40 industry certifications across 12 vendors with live filters, costs, full exam blueprints, DoD 8140 mapping, and salary and role insights.",
      foot: "40 certifications · 12 vendors", cta: "Explore",
  ...
  /* ===========================================================================
     ...
     =========================================================================== */
  function certVer() { var v = window.CDPSE_VER || ""; return v ? "?v=" + v : ""; }
  ...
  function renderCertCatalog(mount) {
    ...
    var search = el("input.cert-search", { type: "text", placeholder: "e.g. CDPSE" });
  ...
  /* Lazily fetch a domain's reading module the first time it's opened, so the
     ...
     script populates CDPSE.reading[id]; once cached it renders instantly. */
  ...
  function loadDomainModule(id, onReady, onFail) {
    ...
    s.src = "assets/js/content/domain" + id + ".js" + (window.CDPSE_VER ? "?v=" + window.CDPSE_VER : "");
    s.async = true;
    s.onload = function () {
  ...
  function openDomain(id) {
    ...
    function render() {
      ...
      Router.replace(readerView("Domain " + id, d.title, "CDPSE Domain " + id + " · " + d.weight + "% of the exam", sections));
    }
  ...
  function openExamMechanics() { Router.open(readerView("Exam mechanics", "Exam Mechanics: CDPSE", "How the exam is built, delivered, and scored", S.examMechanics || [])); }
  function openCareer() { Router.open(readerView("Career guidance", "Career Guidance", "Where CDPSE fits in your path", S.careerGuidance || [])); }
  ...
  /* ===========================================================================
     BOOT
     =========================================================================== */
  /* Populate the hero exam-line from CDPSE.exam so the figures live in exactly
