...
**A comprehensive, open-source ISACA CDPSE study platform.**
...
| | |
| --- | --- |
| **Certification** | CDPSE (Certified Data Privacy Solutions Engineer) |
| **Governing body** | ISACA |
| **Format** | Fixed-form, 120 multiple-choice questions |
| **Duration** | 210 minutes (3.5 hours) |
| **Passing score** | 450 / 800 (scaled, range 200–800) |
| **Domains** | 4 |
| **Experience** | 3 years in data-privacy governance, risk, engineering, or data life-cycle work (no waivers) |
...
| Area | What you get |
| --- | --- |
| **Domain study modules** | 4 rigorous reading interfaces, one per exam domain, with deep definitions, comparison tables, exam tips, and real-world privacy-engineering scenarios. **56 sections** mapped to the official CDPSE outline, lazy-loaded per domain. |
...
| **PBQ simulators** | **30 performance-based questions** across 4 privacy-engineering decision formats, plus a drag-and-drop **Technical Taxonomy Mapping** engine. |
...
| **Mock exam** | A full-length, timed 120-question simulation weighted to the official domain percentages, with a countdown timer, flagging, and a domain-by-domain scoring dashboard. |
...
1. **Read the Exam Mechanics & Career Guidance cards first** to understand the fixed-form format, the 200–800 scoring scale, and the privacy solutions engineer mindset the exam rewards.
...
*This is a personal educational resource. All views and content are entirely my own and do not represent the views, positions, endorsements, or policies of my employer or of any other person, organization, or institution. "ISACA" and "CDPSE" are trademarks or registered trademarks of the Information Systems Audit and Control Association (ISACA), used here only to identify the exam this resource helps you prepare for. All practice questions are original. Released for academic use.*
